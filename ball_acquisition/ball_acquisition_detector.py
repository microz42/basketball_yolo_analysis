...
class BallAcquisitionDetector:
    def __init__(self):
        ...
        self.min_frames = 11
        self.containment_threshold = 0.8   # bbox overlap
    ...
    def get_key_basketball_player_assignment_points(self, player_bbox, ball_center):
        ...
        # check ball bbox within the player bbox
    ...
    def find_best_candidate_for_posession(self, ball_center, player_tracks_frame, ball_bbox):
        ...
        return -1  # indicate no one has the ball
    ...
    def detect_ball_posession(self, player_tracks, ball_tracks):
        ...
        for frame_num in range(num_frames):
            ...
            best_player_id = self.find_best_candidate_for_posession(ball_center,
